...
![terminal-scroll.gif]({{ site.url }}/egitim/temel-linux/metin/terminal-scroll.gif){:class="responsive img-zoomable"}
...
![more.gif]({{ site.url }}/egitim/temel-linux/metin/more.gif){:class="responsive img-zoomable"}
...
![less.gif]({{ site.url }}/egitim/temel-linux/metin/less.gif){:class="responsive img-zoomable"}
...
![tail-f.gif]({{ site.url }}/egitim/temel-linux/metin/tail-f.gif){:class="responsive img-zoomable"}
