...
![dpkg-reconfigure-locales.png]({{ site.url }}/egitim/paket/dpkg-reconfigure-locales.png){:class="responsive img-zoomable"}
...
![kali-repo.png]({{ site.url }}/egitim/paket/kali-repo.png){:class="responsive img-zoomable"}
...
![Red Hat-zoom.png]({{ site.url }}/egitim/paket/redhat-zoom.png){:class="responsive img-zoomable"}
...
![wget.png]({{ site.url }}/egitim/paket/wget.png){:class="responsive img-zoomable"}
...
![wget-download.png]({{ site.url }}/egitim/paket/wget-download.png){:class="responsive img-zoomable"}
