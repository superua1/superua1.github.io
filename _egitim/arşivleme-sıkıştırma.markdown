...
![tape archive]({{ site.url }}/egitim/arsiv/tape_archive.jpg){:class="responsive img-zoomable"}
...
![disk-block.png]({{ site.url }}/egitim/arsiv/disk-block.png){:class="responsive img-zoomable"}
...
![disk-archived-block.png]({{ site.url }}/egitim/arsiv/disk-archived-block.png){:class="responsive img-zoomable"}
...
![zgrep.png]({{ site.url }}/egitim/arsiv/zgrep.png){:class="responsive img-zoomable"}
