...
![packet-for-host.png]({{ site.url }}/egitim/temel-network/router/packet-for-host.png){:class="responsive img-zoomable"}
...
![packet-for-router.png]({{ site.url }}/egitim/temel-network/router/packet-for-router.png){:class="responsive img-zoomable"}

Router cihazları, bağlı oldukları her bir ağda benzersiz bir MAC ve IP adresine sahiptir. 

![router.png]({{ site.url }}/egitim/temel-network/router/router.png){:class="responsive img-zoomable"}
...
![routing-table.png]({{ site.url }}/egitim/temel-network/router/routing-table.png){:class="responsive img-zoomable"}
...
![DC.png]({{ site.url }}/egitim/temel-network/router/DC.png){:class="responsive img-zoomable"}
...
![DC-example.png]({{ site.url }}/egitim/temel-network/router/DC-example.png){:class="responsive img-zoomable"}
...
![DC-routing-problem.png]({{ site.url }}/egitim/temel-network/router/DC-routing-problem.png){:class="responsive img-zoomable"}
...
![ST-route.png]({{ site.url }}/egitim/temel-network/router/ST-route.png){:class="responsive img-zoomable"}

![ST-route2.png]({{ site.url }}/egitim/temel-network/router/ST-route2.png){:class="responsive img-zoomable"}

![ST-route3.png]({{ site.url }}/egitim/temel-network/router/ST-route3.png){:class="responsive img-zoomable"}
...
![Dynamic.png]({{ site.url }}/egitim/temel-network/router/Dynamic.png){:class="responsive img-zoomable"}
...
![ARP-table.png]({{ site.url }}/egitim/temel-network/router/ARP-table.png){:class="responsive img-zoomable"}
...
![INTERNET.png]({{ site.url }}/egitim/temel-network/router/INTERNET.png){:class="responsive img-zoomable"}
...
![router-hierarchy.png]({{ site.url }}/egitim/temel-network/router/router-hierarchy.png){:class="responsive img-zoomable"}
...
![add-router.png]({{ site.url }}/egitim/temel-network/router/add-router.png){:class="responsive img-zoomable"}
...
![linear-connection.png]({{ site.url }}/egitim/temel-network/router/linear-connection.png){:class="responsive img-zoomable"}
...
![router-linear-traffic.png]({{ site.url }}/egitim/temel-network/router/router-linear-traffic.png){:class="responsive img-zoomable"}
...
![linear-connection-error.png]({{ site.url }}/egitim/temel-network/router/linear-connection-error.png){:class="responsive img-zoomable"}
...
![Routers.png]({{ site.url }}/egitim/temel-network/router/Routers.png){:class="responsive img-zoomable"}

Örnek olarak 5 numaralı routerı ele alacak olursak, bu routerın yönlendirme tablosu aşağıdaki gibi olur.

![routing-table-in-hierarchy.png]({{ site.url }}/egitim/temel-network/router/routing-table-in-hierarchy.png){:class="responsive img-zoomable"}
...
![router-redirect1.png]({{ site.url }}/egitim/temel-network/router/router-redirect1.png){:class="responsive img-zoomable"}
...
![router-redirect2.png]({{ site.url }}/egitim/temel-network/router/router-redirect2.png){:class="responsive img-zoomable"}
...
![router-redirect3.png]({{ site.url }}/egitim/temel-network/router/router-redirect3.png){:class="responsive img-zoomable"}
...
![router-redirect4.png]({{ site.url }}/egitim/temel-network/router/router-redirect4.png){:class="responsive img-zoomable"}
...
![router-redirect5.png]({{ site.url }}/egitim/temel-network/router/router-redirect5.png){:class="responsive img-zoomable"}
...
![router-redirect6.png]({{ site.url }}/egitim/temel-network/router/router-redirect6.png){:class="responsive img-zoomable"}
...
![router-redirect7.png]({{ site.url }}/egitim/temel-network/router/router-redirect7.png){:class="responsive img-zoomable"}
...
![router-redirect8.png]({{ site.url }}/egitim/temel-network/router/router-redirect8.png){:class="responsive img-zoomable"}
...
![router-redirect9.png]({{ site.url }}/egitim/temel-network/router/router-redirect9.png){:class="responsive img-zoomable"}
