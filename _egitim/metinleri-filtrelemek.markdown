...
![23.png]({{ site.url }}/egitim/metin/23.png){:class="responsive img-zoomable"}
...
![awk1.png]({{ site.url }}/egitim/metin/awk1.png){:class="responsive img-zoomable"}
...
![awk1.gif]({{ site.url }}/egitim/metin/awk1.gif){:class="responsive img-zoomable"}
...
![awk2.png]({{ site.url }}/egitim/metin/awk2.png){:class="responsive img-zoomable"}
...
![terminal-scroll.gif]({{ site.url }}/egitim/metin/terminal-scroll.gif){:class="responsive img-zoomable"}
...
![tty-scroll.png]({{ site.url }}/egitim/metin/tty-scroll.png){:class="responsive img-zoomable"}
...
![without-more.png]({{ site.url }}/egitim/metin/without-more.png){:class="responsive img-zoomable"}

Bu sorunu çözmek içim bu çıktıları pipe ile `more` aracına yönlendirip çıktılara parça parça bakabiliriz. 

![more.gif]({{ site.url }}/egitim/metin/more.gif){:class="responsive img-zoomable"}
...
![more-with-file.gif]({{ site.url }}/egitim/metin/more-with-file.gif){:class="responsive img-zoomable"}
...
![quit-more.gif]({{ site.url }}/egitim/metin/quit-more.gif){:class="responsive img-zoomable"}
...
![less.gif]({{ site.url }}/egitim/metin/less.gif){:class="responsive img-zoomable"}
...
![tail-f.gif]({{ site.url }}/egitim/metin/tail-f.gif){:class="responsive img-zoomable"}
